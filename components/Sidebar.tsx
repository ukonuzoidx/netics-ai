...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      >
        <div className="p-4 border-b border-gray-200/50 space-y-2">
          <Button
          ...
          <Button
            ...
            variant="outline"
            className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white border-0 shadow-sm"
          >
            <Phone className="mr-2 h-4 w-4" /> Voice Chat
          </Button>
          <Button
            onClick={() => {
            ...
            variant="outline"
            className="w-full bg-white hover:bg-gray-50 text-gray-700 border border-gray-200/50"
          >
